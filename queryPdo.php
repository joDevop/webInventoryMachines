...
$query00 = $conexion->query("SELECT id_machine,type_machine,manufacturer,model,serial,ram_slot_00,ram_slot_01,hard_drive,cpu,ip_range,mac_address,anydesk,location,comment,create_date,update_at,imagen,campus_v1a 
...
//crear otra consulta donde obtenga el valor de la sede para mostrar en el select de modal-update

...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark shadow">
      <a href="#" class="btn btn-success" id="menu-toggle"><i class="fas fa-bars"></i></a>
    </nav>
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav" style="margin-top: 80px;">
        <center>
          <img src="img\ic_seo-and-web.svg" class="profile_image" alt="" />
          <h4>Admin</h4>
        </center>
        <li><a href="#">Table<i class="fas fa-table"></i></a></li>
        <li><a href="#">Settings<i class="fas fa-user-cog"></i></a></li>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="table-responsive" style="margin-bottom: 20px; width: 1600px;">
